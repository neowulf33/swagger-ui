...
(function() {
  var ApiKeyAuthorization, PasswordAuthorization, SwaggerApi, SwaggerAuthorizations, SwaggerHttp, SwaggerModel, SwaggerModelProperty, SwaggerOperation, SwaggerRequest, SwaggerResource, BasicAuthorization,
  ...
  BasicAuthorization = (function() {
    BasicAuthorization.prototype.value = null;
    function BasicAuthorization(value) {
      this.value = value;
    }
    BasicAuthorization.prototype.apply = function(obj) {
      return obj.headers["Authorization"] = this.value;
    };
